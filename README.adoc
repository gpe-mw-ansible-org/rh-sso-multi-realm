...
+
-----
$ ansible-galaxy install jbride.rh-sso-multi-realm
-----
...
- hosts: all
  ...
  vars_files:
  roles:
    - jbride.rh-sso-multi-realm
" > /tmp/rh-sso-multi-realm.yml
-----
...
+
-----
$ ansible-playbook -i localhost, -c local /tmp/rh-sso-multi-realm.yml \
